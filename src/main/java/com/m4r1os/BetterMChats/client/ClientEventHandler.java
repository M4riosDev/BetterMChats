    ...
    public static void onClientChat(ClientChatEvent event) {
        ...
        if (message.startsWith("/hudmute ")) {
            ...
            Minecraft.getInstance().gui.getChat().addMessage(
                    new TextComponent("§a[BetterMChats] Muted: " + channel.toUpperCase()));
            return;
        }
        ...
        if (message.startsWith("/hudunmute ")) {
            ...
            Minecraft.getInstance().gui.getChat().addMessage(
                    new TextComponent("§a[BetterMChats] Unmuted: " + channel.toUpperCase()));
            return;
        }
        ...
        if (message.startsWith("/hudmutedsz") || message.equals("/hudmuted")) {
            ...
            if (mutedChannels.isEmpty()) {
                Minecraft.getInstance().gui.getChat().addMessage(
                        new TextComponent("§c[BetterMChats] No channels muted."));
            } else {
                Minecraft.getInstance().gui.getChat().addMessage(
                        new TextComponent("§b[BetterMChats] Muted channels: " + String.join(", ", mutedChannels)));
            }
        }
    }
