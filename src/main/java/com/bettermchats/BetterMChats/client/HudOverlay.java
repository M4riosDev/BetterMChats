...
public class HudOverlay {
    ...
    @SubscribeEvent
    public static void onScreenOpen(ScreenEvent.InitScreenEvent e) {
        if (e.getScreen() instanceof ChatScreen && !(e.getScreen() instanceof FiveMChatScreen)) {
            Minecraft.getInstance().setScreen(new FiveMChatScreen());
        }
    }
    ...
    public static void onClientChat(ClientChatReceivedEvent e) {
        try {
            net.minecraft.network.chat.Component c = e.getMessage();
